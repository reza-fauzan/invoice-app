...
@section('content')
    ...
    <div class="page-header">
        <div>
            ...
            <p>Perbarui data pelanggan <strong>{{ $pelanggan->nama_pelanggan }}</strong>.</p>
        </div>
        ...
        <form action="{{ route('pelanggan.update', $pelanggan) }}" method="POST">
            ...
            <div style="display: flex; flex-direction: column; gap: 20px;">
                ...
                <div>
                    ...
                    <input type="text" name="nama_pelanggan" id="nama_pelanggan" class="form-input" placeholder="Masukkan nama pelanggan" value="{{ old('nama_pelanggan', $pelanggan->nama_pelanggan) }}" required>

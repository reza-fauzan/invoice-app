...
<script>
    ...
    function addItem(data = {}) {
        ...
        row.innerHTML = `
            ...
            <td style="padding: 6px 4px;">
                <input type="text" name="items[${itemIndex}][sa_no]" class="form-input" value="${data.sa_no || ''}" placeholder="SA No" style="${inputStyle} font-family: var(--font-mono);">
            </td>
            <td style="padding: 6px 4px;">
            ...
            <td style="padding: 6px 4px;">
                <input type="number" name="items[${itemIndex}][tonase]" class="form-input tonase-input" value="${data.tonase || ''}" step="0.01" min="0" required style="${inputStyle} font-family: var(--font-mono); text-align: right;">
            </td>
            <td style="padding: 6px 4px;">
    ...
    function showNopolDropdown(idx) {
        closeAllDropdowns();
        filterNopol(idx);
    }
    ...
    function showPenerimaDropdown(idx) {
        closeAllDropdowns();
        filterPenerima(idx);
    }
